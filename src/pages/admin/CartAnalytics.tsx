...
export default function CartAnalytics() {
  ...
  const [activeTab, setActiveTab] = useState<"painting-ips" | "sessions" | "products">("painting-ips");
      ...
      <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200/80 pb-6">
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">
              Track IP addresses, geolocations, and activity of visitors who have paintings in their cart in real-time.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-5 rounded-xl border border-zinc-200/80 shadow-sm flex flex-col justify-between">
            ...
            <p className="text-[11px] text-zinc-400 mt-2">Visitors holding paintings in cart</p>
          </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-zinc-200/80 shadow-sm flex flex-col justify-between">
            ...
            <p className="text-[11px] text-zinc-400 mt-2">Active within last 24 hours</p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              Painting IP Tracker ({paintingIpGroups.length})
            </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                type="text"
                placeholder="Search IP, painting title, city..."
                value={searchQuery}
        ...
        {loading ? (
          ...
          /* TAB 1: Painting IP Address Tracker */
          <div className="space-y-6">
            {filteredPaintingIpGroups.length === 0 ? (
              <div className="bg-white rounded-xl border border-zinc-200/80 p-12 text-center text-zinc-400">
                ...
                <p className="text-sm font-medium text-zinc-700">No painting IP tracking sessions found</p>
                <p className="text-xs text-zinc-400 mt-1">
                  When visitors add paintings or original artworks to their cart on the store, their IP address, geolocation, and session details will automatically map here.
                </p>
              </div>
            ) : (
          ...
          /* TAB 2: Active Cart Sessions Table */
          ...
          /* TAB 3: Product Demand Breakdown */
          <div className="bg-white rounded-xl border border-zinc-200/80 shadow-sm overflow-hidden">
