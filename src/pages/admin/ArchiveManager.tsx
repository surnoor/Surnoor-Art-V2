        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          ...
          <div className="relative flex-1 min-w-[150px]">
            ...
            <input 
              ...
              className="w-full pl-9 pr-4 py-2 border rounded-md text-sm focus:ring-2 focus:ring-primary outline-none"
            />
          </div>
          <button 
            onClick={() => setLocation('/admin/new-artwork')}
            className={`flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-md transition-opacity text-sm font-medium hover:opacity-90 cursor-pointer whitespace-nowrap`}
          >
            <Plus className="w-4 h-4" /> <span className="hidden sm:inline">Add Artwork</span><span className="sm:hidden">Add</span>
          </button>
        </div>
      </div>
